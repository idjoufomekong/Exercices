...
namespace POO
{
    public abstract class Distributeur
    {
        public abstract decimal MontantMax { get; }
    }

    public enum Boissons { CaféNoir, CaféCrème, Thé, PotageTomate }

	public class DistributeurBoisson:Distributeur
	{
        ...
        #region Propriétés
        public override decimal MontantMax { get { return _paiement; } }
